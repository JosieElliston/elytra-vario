...
public final class DialSpeedometerElement implements HudElement {
	...
	private static void draw(GuiGraphics graphics, Font font, DialSpeedometer dial,
	...
	private static void drawFace(GuiGraphics graphics, DialSpeedometer dial,
			int hubX, int hubY) {
		int rim = dial.rim();
	...
	private static void drawScale(GuiGraphics graphics, Font font, DialSpeedometer dial,
			int hubX, int hubY) {
	...
	private static void tick(GuiGraphics graphics, DialSpeedometer dial, int hubX,
	...
	private static void needle(GuiGraphics graphics, DialSpeedometer dial, int hubX,
	...
	private static void label(GuiGraphics graphics, Font font, DialSpeedometer dial,
	 ...
	 */
	private static void marker(GuiGraphics graphics, DialSpeedometer dial, int hubX,
			int hubY, double speed, double length, int color) {
		radial(graphics, hubX, hubY, dial.angle(speed), dial.markerFrom(length),
				dial.markerTo(length), MARKER_WEIGHT, color);
	}

	private static void drawNeedles(GuiGraphics graphics, DialSpeedometer dial,
	...
	private static void drawNeedle(GuiGraphics graphics, DialSpeedometer dial,
	 ...
	 */
	private static void accelerationArrow(GuiGraphics graphics, DialSpeedometer dial,
	 ...
	 * an off-center point.
	 */
	private static void barb(GuiGraphics graphics, double endX, double endY,
	...
	private static void smoothLine(GuiGraphics graphics, double x0, double y0,
